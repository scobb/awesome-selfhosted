...
- [Beam](https://beam.keylightdigital.com/) - Lightweight, cookie-free, GDPR-compliant web analytics built on Cloudflare's edge network. ([Source Code](https://github.com/scobb/beam)) `MIT` `Nodejs`
